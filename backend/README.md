...
## Project Structure
    ...
    ├── testapiautosetting_127248  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127248`
...
2. Clone this repo and `cd testapiautosetting_127248`
